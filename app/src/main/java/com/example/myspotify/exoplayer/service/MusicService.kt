...
import com.example.myspotify.exoplayer.FirebaseMusicSource
import com.example.myspotify.exoplayer.MusicNotificationManager
import com.example.myspotify.exoplayer.callbacks.MusicPlaybackPreparer
import com.example.myspotify.exoplayer.callbacks.MusicPlayerEventListener
...
import com.example.myspotify.util.Constants.NETWORK_ERROR
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    override fun onLoadChildren(
        ...
        when(parentId) {
            MEDIA_ROOT_ID -> {
                val resultSent = firebaseMusicSource.whenReady {isIntialized ->
                    if(isIntialized) {
    ...
    //This class provides song and metadata to notification to display there
